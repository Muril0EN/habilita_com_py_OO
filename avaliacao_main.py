...
print("Referência: distância entre as mãos > {} = mobilidade reduzida".format(tamanho_mao * 1.5))
print("\n")
...
print("\n")
print("Core")
print("Prancha ventral: {}            | score: {}".format(tempo_prancha_ventral, resistencia_prancha_ventral))
print("Extensão da coluna: {}         | score: {}".format(tempo_extensao_coluna, resistencia_extensao_coluna))
print("Prancha lateral (direito): {}  | score: {}".format(tempo_prancha_lateral_direita, resistencia_prancha_lateral_direita))
print("Prancha lateral (esquerdo): {} | score: {}".format(tempo_prancha_lateral_esquerda, resistencia_prancha_lateral_esquerda))
